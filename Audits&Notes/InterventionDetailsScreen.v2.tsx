...
import { RootStackParamList } from '../mobile/src/navigation/AppNavigator';
import { InterventionService, Intervention, InterventionStatus } from '../mobile/src/services/intervention.service';
import { ActivityService, Activity, ActivityCategory } from '../mobile/src/services/activity.service';
import { apiService } from '../mobile/src/services/api.service';
import { showToast } from '../mobile/src/utils/toast';
import { PhotoPicker } from '../mobile/src/components/PhotoPicker';
import { PhotoGallery } from '../mobile/src/components/PhotoGallery';
import { SignaturePad } from '../mobile/src/components/SignaturePad';
import { TimeSheet } from '../mobile/src/components/TimeSheet';
import { hapticService } from '../mobile/src/services/haptic.service';
import { SkeletonInterventionDetails } from '../mobile/src/components/ui/SkeletonLoaders';
import { AnimatedButton, AnimatedFadeIn, AnimatedCheckmark } from '../mobile/src/components/ui/AnimatedComponents';
import { CollapsibleInfoSection, InfoField } from '../mobile/src/components/CollapsibleInfoSection';
import { useAuthStore, authSelectors } from '../mobile/src/stores/authStore.v2';
import { UserRole } from '../mobile/src/types/user.types';
